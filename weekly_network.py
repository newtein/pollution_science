from make_network import MakeNetwork
import datetime
import time
...
class WeeklyNetwork:
    ...
    def create_weekly_network(self):
        for index, week_pair in enumerate(self.week_pairs):
            start = time.time()
            obj = MakeNetwork('PM2', start_date=week_pair[0], end_date=week_pair[1])
...
if __name__ == "__main__":
    ...
    """
    obj = WeeklyNetwork('PM2', start_date="08-01-2020", end_date="08-03-2020")
